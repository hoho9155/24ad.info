...
INSERT INTO `__PREFIX__cities` (`country_code`, `name`, `longitude`, `latitude`, `feature_class`, `feature_code`, `subadmin1_code`, `subadmin2_code`, `population`, `time_zone`, `active`, `created_at`, `updated_at`) VALUES ('VA','{\"en\":\"Vatican City\"}',12.45,41.90,'P','PPLC',NULL,NULL,829,'Europe/Vatican',1,'2018-08-16 23:00:00','2018-08-16 23:00:00');
