...
INSERT INTO `__PREFIX__cities` (`country_code`, `name`, `longitude`, `latitude`, `feature_class`, `feature_code`, `subadmin1_code`, `subadmin2_code`, `population`, `time_zone`, `active`, `created_at`, `updated_at`) VALUES ('GI','{\"en\":\"Gibraltar\"}',-5.35,36.14,'P','PPLC','GI.00',NULL,26544,'Europe/Gibraltar',1,'2019-11-17 23:00:00','2019-11-17 23:00:00');
