...
INSERT INTO `__PREFIX__cities` (`country_code`, `name`, `longitude`, `latitude`, `feature_class`, `feature_code`, `subadmin1_code`, `subadmin2_code`, `population`, `time_zone`, `active`, `created_at`, `updated_at`) VALUES ('CC','{\"en\":\"West Island\"}',96.82,-12.16,'P','PPLC',NULL,NULL,120,'Indian/Cocos',1,'2018-08-16 23:00:00','2018-08-16 23:00:00');
