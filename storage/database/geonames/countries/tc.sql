...
INSERT INTO `__PREFIX__cities` (`country_code`, `name`, `longitude`, `latitude`, `feature_class`, `feature_code`, `subadmin1_code`, `subadmin2_code`, `population`, `time_zone`, `active`, `created_at`, `updated_at`) VALUES ('TC','{\"en\":\"Cockburn Town\"}',-71.14,21.46,'P','PPLC','TC.00',NULL,3720,'America/Grand_Turk',1,'2019-09-04 23:00:00','2019-09-04 23:00:00');
