...
class DistanceHelper
{
	 ...
	 * @return bool
	 */
	public static function checkIfFunctionExists(?string $name): bool
	{
	 ...
	 * @return bool
	 */
	public static function createFunction(string $sql): bool
	{
		try {
	...
	private static function extractFunctionName(string $sql): ?string
	{
		...
		$name = !empty($matches[1]) ? trim($matches[1]) : null;
