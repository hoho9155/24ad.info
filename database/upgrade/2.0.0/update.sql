...
DELETE FROM `__PREFIX__settings` WHERE `key`='purchase_code';

INSERT INTO `__PREFIX__settings` (`key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`)
VALUES
	('purchase_code', 'Purchase Code', '', 'LaraClassifier Purchase Code', '{"name":"value","label":"Value","type":"text"}', 1, 6, 7, 2, 1, NULL, '2016-11-10 19:29:35');
