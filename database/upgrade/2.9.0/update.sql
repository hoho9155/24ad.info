...
ALTER TABLE `__PREFIX__languages` ADD `russian_pluralization` TINYINT(1) UNSIGNED NULL DEFAULT '0' AFTER `script`;
ALTER TABLE `__PREFIX__currencies`
...
UPDATE `__PREFIX__currencies` SET `decimal_places` = '2';
UPDATE `__PREFIX__currencies` SET `decimal_separator` = '.';
UPDATE `__PREFIX__currencies` SET `thousand_separator` = ',';

ALTER TABLE `__PREFIX__ads` CHANGE `price` `price` DECIMAL(10,2) UNSIGNED NULL DEFAULT NULL;
ALTER TABLE `__PREFIX__packs` CHANGE `price` `price` DECIMAL(10,2) UNSIGNED NULL DEFAULT NULL;
ALTER TABLE `__PREFIX__countries` CHANGE `phone` `phone` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;
...
RENAME TABLE `__PREFIX__packs` TO `__PREFIX__packages`;
ALTER TABLE `__PREFIX__payments` CHANGE `pack_id` `package_id` INT(10) UNSIGNED NULL DEFAULT NULL;
ALTER TABLE `__PREFIX__ads` CHANGE `pack_id` `package_id` INT(10) UNSIGNED NULL DEFAULT NULL;
