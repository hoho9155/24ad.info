...
TRUNCATE TABLE `__PREFIX__advertising`;
--
-- Dumping data for table `advertising`
--

INSERT INTO `__PREFIX__advertising` (`id`, `slug`, `provider_name`, `tracking_code_large`, `tracking_code_medium`, `tracking_code_small`, `active`) VALUES
...
TRUNCATE TABLE `__PREFIX__settings`;
--
-- Dumping data for table `settings`
--

INSERT INTO `__PREFIX__settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES
(1, 'app_name', 'App Name', 'SiteName', 'Website name', '', 0, 2, 13, 1, 1, NULL, '2016-06-15 00:33:22'),
(2, 'app_logo', 'Logo', '', 'Website Logo', '{"name":"value","label":"Value","type":"browse"}', 1, 3, 4, 2, 1, NULL, '2016-06-14 22:27:49'),
(3, 'app_slogan', 'App Slogan', 'SiteName - Hello, World!', 'Website slogan (for Meta Title)', '', 1, 5, 6, 2, 1, NULL, '2016-06-14 22:27:49'),
...
INSERT INTO `__PREFIX__settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`)
VALUES
