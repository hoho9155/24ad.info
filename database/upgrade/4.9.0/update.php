...
try {
	...
	if (\Jackiedo\DotenvEditor\Facades\DotenvEditor::keyExists('MULTI_COUNTRY_SEO_LINKS')) {
		\Jackiedo\DotenvEditor\Facades\DotenvEditor::deleteKey('MULTI_COUNTRY_SEO_LINKS');
	}
