...
;(function($){ "use strict";
    ...
    Iconpicker.ICONSET = {
        ...
        octicons: $.iconset_octicons || Iconpicker.ICONSET_EMPTY,
        typicons: $.iconset_typicons || Iconpicker.ICONSET_EMPTY,
        weathericons: $.iconset_weathericons || Iconpicker.ICONSET_EMPTY
    };
                    ...
                    $this.on('click', function(e) {
                        ...
                        $this.popover({
                            ...
                            if (typeof el !== 'undefined') {
                                // List the element/object properties
