...
<br><br>Если у вас есть сомнения относительно серьезности рекламодателя, немедленно свяжитесь с нами. Мы сделаем все возможное чтоб защитить вас чтоб вы не стали жертвой обмана.',
    ...
    'reset_password_content_1' => 'Вы получили это письмо, потому что мы получили запрос на сброс пароля для вашей учетной записи.',
    'reset_password_content_2' => 'Срок действия этой ссылки для сброса пароля истекает через :expireTimeString минут.',
    ...
    'user_notification_content_3' => 'Зарегистрировано: :now по :time<br>Auth field: :authField<br>Email: :email<br>Phone: :phone',
...
<br><strong>Причина оплаты:</strong> Объявление #:postId - :packageName
